<template>
  <section id="sobre" class="py-20 bg-background relative overflow-hidden">
    ...
    <div class="container mx-auto px-6 lg:px-20 pt-16">
      <div class="text-center mb-16 space-y-4">
        ...
        <h2
          class="text-4xl md:text-5xl font-display font-bold text-foreground mt-3 leading-tight"
        >
          Cuidar da mente é um
          <span class="text-primary italic"> ato de coragem </span>
        </h2>
      </div>
      ...
      <div class="grid lg:grid-cols-2 gap-x-16 gap-y-12 items-start">
        <div class="order-1">
          <div class="relative">
            ...
            <div
              class="absolute -bottom-4 -right-4 w-24 h-24 bg-primary/10 rounded-full"
            />
            <div
              class="absolute -top-4 -left-4 w-16 h-16 bg-sage/30 rounded-xl rotate-12"
            />
          </div>
        </div>

        <div class="order-2 lg:row-span-2 self-start space-y-8">
        ...
        <div class="order-3 self-start">
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
            <div
              v-for="item in features"
              :key="item.title"
              class="flex flex-col items-center text-center p-6 rounded-2xl bg-lavender-light/50 hover:bg-lavender-light transition-colors"
            >
              <div
